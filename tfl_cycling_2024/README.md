...
![Bike histogram: trip count among all bikes](plots/02_bikes.py)
...
![Bike cumulative distribution: first use date](plots/2_bike_first_use_date.png)
...
![Bike correlations: trip count vs first trip date](plots/2_bike_corr_1.png)
